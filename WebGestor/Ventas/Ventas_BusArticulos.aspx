<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ventas_BusArticulos.aspx.vb" Inherits="Ventas_Ventas_BusArticulos" %>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server" >
                    <ContentTemplate>
                        ...
                        <div id="Modal2" class="dere_modal_left" > 
                                ...
                                <br />
                                <div style="border: 0px none #FFFFFF; overflow: auto; height: 200px; width: 100%;" > 
                                    <asp:DataList ID="FlexArt" runat="server"  Font-Names="Arial" Font-Size="8pt" EnableViewState="False" RepeatColumns="3" BorderColor="White" OnItemCommand ="FlexArt_ItemCommand"  >
                                        <ItemTemplate>
                                        ...
                                        <br />
                                        <asp:Button ID="btnSeleccionar" runat="server" Text="Seleccionar" CommandName="btnSeleccionar" Font-Names="Arial" Font-Size="8pt" />
                                    </ItemTemplate>
                                </asp:DataList>
                                </div>          
                                <br/>      
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="FlexArt" EventName="ItemCommand" />
                    </Triggers>
                </asp:UpdatePanel>
                </div>  
        </section>
