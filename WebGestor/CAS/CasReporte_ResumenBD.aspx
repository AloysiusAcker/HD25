<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="CasReporte_ResumenBD.aspx.vb" Inherits="CasReporte_ResumenBD" title="CAS" %>
            ...
            <tr>
                ...
                <td align="left" style="height: 50px; text-align: center; width: 550px;" valign="top" colspan="1">
                    <div id="lblTitulo" runat="server" class="EstiloTitleMenu" style="font-weight: bold;
                        ...
                        Resumen de Base de Datos x Mes</div>
                </td>
                <td align="left" style="width: 25px; height: 50px" valign="top">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left" style="height: 22px; width: 550px;" valign="top" colspan="1">
                    ...
                    <CR:CrystalReportSource ID="CR1" runat="server">
                        <Report FileName="C:\Inetpub\wwwroot\WebCas\Reportes\ResumenBD.rpt">
                        </Report>
