...
Imports System.Data
Partial Class Cas_ListaIncidentes_Nivel2
    ...
    Private Sub Llenar_Grilla()
        Try
            ...
            dtListado = obj.CasLista_IncidentesUsuario(Session("CodEmpresa"), pEstado, pCodigo, pImportancia, pComponente, pElemento, pTipo, HttpContext.Current.User.Identity.Name, "4",Session("Ruta_Emp"))
            If dtListado.Rows.Count > 0 Then
                dtConsulta = obj.CasConsulta_ExisteN1Usuario(HttpContext.Current.User.Identity.Name,Session("Ruta_Emp"))
                If dtConsulta.Rows.Count = 1 Then
                    For Each drMenuItem As Data.DataRow In dtListado.Rows
                        If Nu(drMenuItem("APROB_ASIGNADO_PERSONA")) = HttpContext.Current.User.Identity.Name Then
                            dRow = dt.NewRow
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            obj.InsUpd_Incidente(Session("CodEmpresa"), Problema, Session("User"), "", pCodIncidente, cboNImportancia.SelectedValue.Trim, Tipo2, Tipo3, QuitaComilla(txtNDescripcion.Text.Trim), "", "8", 0, "", "", "", pIniLlamada, pSeguimiento, "", "", "",Session("Ruta_Emp"))
    ...
    Private Sub Cargar_Informacion(ByVal sender As Object, ByVal e As System.EventArgs, ByVal psEstado As String, ByVal psSeguimiento As String, ByVal psUserRedirec As String, ByVal psUserRegistra As String)
        ...
        lblNombreUsuarioSistema.Text = " " + txtUsuario.Text.Trim + " - " + txtNombre.Text.Trim
        Try
            If psEstado <> "5" Or psEstado <> "6" Then
                ...
                If psEstado = "8" Then
                    ...
                    If lblRedireccion2.Text = "" Then
                        ...
                        dt = Nothing
                    End If
                    If lblRedireccion2.Text = "" Then lblRedireccion1.Visible = False : lblRedireccion2.Visible = False
                Else
                ...
                If psEstado = "3" Or psEstado = "4" Then
                    obj.InsUpd_Incidente(Session("CodEmpresa"), 0, HttpContext.Current.User.Identity.Name, "", pCodIncidente, "", 0, 0, "", "", "7", 0, "", "", "", "", "0", "", "", "",Session("Ruta_Emp"))
                End If
            End If
        Catch Ex As SqlException
            lblErrorF.Visible = True
