...
Imports System.Data
Partial Class Cas_DefineTablas2
    ...
    Private Sub Llenar_GrillaE()
        Try
            ...
            dtListado = obj.CasLista_Empresa(Session("Ruta_Emp"))
    ...
    Protected Sub Ficha_ActiveTabChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles Ficha.ActiveTabChanged
        ...
        If Ficha.ActiveTabIndex = 1 Then
            Call Llenar_GrillaO()
            Call Cargar_Empresa(cboEmpresa, Session("Ruta_Emp"))
            Ficha.Height = 310
        End If
    ...
    Private Sub Llenar_GrillaO()
        Try
            ...
            Dim dt As New DataTable
            Dim obj As New ModuloCas
            dtListado = obj.CasLista_Oficina(Session("Ruta_Emp"))
    ...
    Private Sub Llenar_GrillaP()
        Try
            ...
            Dim dt As New DataTable
            Dim obj As New ModuloCas
            dtListado = obj.CasLista_Puesto(Session("Ruta_Emp"))
    ...
    Private Sub Llenar_GrillaC()
        Try
            ...
            Dim dt As New DataTable
            Dim obj As New ModuloCas
            dtListado = obj.CasLista_Criterio(Session("CodEmpresa"),Session("Ruta_Emp"))
    ...
    Protected Sub btnEGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            If lblEtiquetaE.Text = "Nueva Empresa" Then
                dt = obj.CasConsulta_ExisteEmpresa(txtENombre.Text.Trim,Session("Ruta_Emp"))
                If dt.Rows.Count = 0 Then
                    obj.InsUpd_Empresa(pCodEmpresa, txtENombre.Text.Trim, HttpContext.Current.User.Identity.Name, "1",Session("Ruta_Emp"))
                Else
                    dt = Nothing
            ...
            ElseIf lblEtiquetaE.Text = "Editar Empresa" Then
                ...
                obj.InsUpd_Empresa(pCodEmpresa, txtENombre.Text.Trim, HttpContext.Current.User.Identity.Name, "2",Session("Ruta_Emp"))
            End If
        Catch Ex As SqlException
            lblError.Visible = True
            lblError.Text = "Ha ocurrido un error en el registro de la Base de Datos:<br>" & Ex.Message
    ...
    Protected Sub btnOGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            If lblEtiquetaO.Text = "Nueva Oficina" Then
                dt = obj.CasConsulta_ExisteOficina(txtOCodInt.Text.Trim,Session("Ruta_Emp"))
                If dt.Rows.Count = 0 Then
                    obj.InsUpd_Oficina(pCodOficina, txtOCodInt.Text.Trim, txtONombre.Text.Trim, cboEmpresa.SelectedValue.Trim, HttpContext.Current.User.Identity.Name, "1",Session("Ruta_Emp"))
                Else
            ...
            Else
                ...
                obj.InsUpd_Oficina(pCodOficina, txtOCodInt.Text.Trim, txtONombre.Text.Trim, cboEmpresa.SelectedValue.Trim, HttpContext.Current.User.Identity.Name, "2",Session("Ruta_Emp"))
                'Else
    ...
    Protected Sub btnPGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If lblEtiquetaP.Text = "Nuevo Puesto" Then
                dt = obj.CasConsulta_ExistePuetso(txtPNombre.Text.Trim, "", "1",Session("Ruta_Emp"))
                If dt.Rows.Count = 0 Then
                    obj.InsUpd_Puesto(pcodigo, txtPNombre.Text.Trim, "", "1",Session("Ruta_Emp"))
                Else
                    dt = Nothing
            ...
            ElseIf lblEtiquetaP.Text = "Editar Puesto" Then
                ...
                obj.InsUpd_Puesto(pcodigo, txtPNombre.Text.Trim, "", "2",Session("Ruta_Emp"))
            End If
        Catch Ex As SqlException
            lblErrorP.Visible = True
            lblErrorP.Text = "Ha ocurrido un error en el registro de la Base de Datos:<br>" & Ex.Message
    ...
    Protected Sub FlexP_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FlexP.RowCommand
        ...
        If e.CommandName = "Editar" Then
            ...
            lblIngresoP.Visible = True
            txtPNombre.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(FlexP.Rows(Index).Cells(2).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
    ...
    Protected Sub btnCGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            If lblEtiquetaC.Text = "Nuevo Criterio" Then
                dt = obj.CasConsulta_ExisteCriterio(txtCDescripcion.Text.Trim, cboCTipo.SelectedValue.Trim,Session("Ruta_Emp"))
                If dt.Rows.Count = 0 Then
                    obj.InsUpd_Criterio(Session("CodEmpresa"), cboCTipo.SelectedValue.Trim, pCodigo, txtCDescripcion.Text.Trim, Inicia, "1",Session("Ruta_Emp"))
                Else
                    dt = Nothing
            ...
            ElseIf lblEtiquetaC.Text = "Editar Criterio" Then
                ...
                obj.InsUpd_Criterio(Session("CodEmpresa"), cboCTipo.SelectedValue.Trim, pCodigo, txtCDescripcion.Text.Trim, Inicia, "2",Session("Ruta_Emp"))
            End If
        Catch Ex As SqlException
            lblErrorC.Visible = True
            lblErrorC.Text = "Ha ocurrido un error en el registro de la Base de Datos:<br>" & Ex.Message
