<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Cas_Lista_Enlace_TemasAyuda.aspx.vb" Inherits="Cas_Lista_Enlace_TemasAyuda" title="GestorPlus" %>
            ...
            <tr>
                ...
                <td align="left" colspan="5" style="height: 50px; text-align: center;" valign="top">
                    <div id="lblTitulo" runat="server" class="EstiloTitleMenu" style="font-weight: bold;
                        ...
                        Lista Temas de Ayuda y Enlaces</div>
                </td>
                <td align="left" style="width: 25px; height: 50px" valign="top">
                </td>
            </tr>
...
<Triggers __designer:dtid="3096224743817250">
...
</asp:UpdatePanel> </TD></TR><TR><TD style="VERTICAL-ALIGN: middle; HEIGHT: 22px" vAlign=top align=left><asp:Label id="lblErrorTA" runat="server" ForeColor="Red" Font-Size="8pt" Font-Names="Arial" __designer:dtid="3096224743817255" __designer:wfdid="w270"></asp:Label> </TD></TR></TBODY></TABLE></DIV>
</ContentTemplate>
<HeaderTemplate>
Temas de Ayuda
</HeaderTemplate>
