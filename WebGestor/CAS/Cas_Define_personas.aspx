<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Cas_Define_personas.aspx.vb" Inherits="Cas_Define_personas" title="GestorPlus" %>
...
<asp:BoundField DataField="TBCAS_PERSONA_CODIGO" HeaderText="Codigo">
<ItemStyle HorizontalAlign="Right" VerticalAlign="Top" Width="50px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PERSONA_USUARIO" HeaderText="Usuario">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="50px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PERSONA_APELLIDOS" HeaderText="Apellidos">
<ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="150px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PERSONA_NOMBRE" HeaderText="Nombre">
<ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="150px"></ItemStyle>
</asp:BoundField>
...
<asp:BoundField DataField="TBCAS_TELEFONO" HeaderText="Telefono">
<ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="50px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_ANEXO" HeaderText="Anexo">
<ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="50px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_CORREO_ELECTRONICO" HeaderText="Correo Electr&#243;nico">
<ItemStyle HorizontalAlign="Left" VerticalAlign="Top" Width="150px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_OFICINA">
<ItemStyle ForeColor="White" Width="0px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_TERRITORIO">
<ItemStyle ForeColor="White" Width="0px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PUESTO">
<ItemStyle ForeColor="White" Width="0px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PERSONA_ANTIGUEDAD">
<ItemStyle ForeColor="White" Width="0px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="TBCAS_PERSONA_BANCA">
<ItemStyle ForeColor="White" Width="0px"></ItemStyle>
</asp:BoundField>
</Columns>
