<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Cas_ImportarPersona.aspx.vb" Inherits="Cas_ImportarPersona" title="CAS" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 460px; height: 22px; text-align: right"
                    valign="top">
                    <asp:Button ID="btnArchTexto" runat="server" BackColor="LightGray" BorderColor="Gray"
                        ...
                        onmouseover="this.style.fontWeight='bolder'" Text="Importar Arch. Texto" Width="136px" /><asp:Button
                            ID="btnArchExcel" runat="server" BackColor="LightGray" BorderColor="Gray" BorderStyle="Outset"
                            BorderWidth="1px" CssClass="EstiloBoton" EnableTheming="True" Font-Names="Arial"
                            Font-Size="8pt" ForeColor="Gray" OnClick="btnArchExcel_Click" onmouseout="this.style.fontWeight='normal'"
                            onmouseover="this.style.fontWeight='bolder'" Text="Importar Arch. Excel" Width="136px" /></td>
                <td align="left" style="width: 25px; height: 22px" valign="top">
                </td>
            </tr>
            <tr>
