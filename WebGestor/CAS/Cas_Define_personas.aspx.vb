...
Imports System
Partial Class Cas_Define_personas
    ...
    Private Sub Llenar_Grilla()
        Try
            ...
            dtListado = obj.CasLista_Personas(Session("Ruta_Emp"))
    ...
    Private Sub Cargar_Puesto()
        ...
        Try
            ...
            dt = obj.CasLista_Puesto(Session("Ruta_Emp"))
            cboPuesto.DataSource = dt
            cboPuesto.DataTextField = "DESCRIPCION"
            cboPuesto.DataValueField = "PUESTO_CODIGO"
            cboPuesto.DataBind()
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            If lblEtiqueta.Text = "Ingresar Persona" Then
                ...
                CmdGlobal.CommandText = "SELECT MAX(APROB_CODIGO) FROM TBCAS_INCIDENTES WHERE EMPRESA_CODIGO='" & Session("CodEmpresa") & "'"
                Rs = CmdGlobal.ExecuteReader
                If Rs.HasRows Then
                    While Rs.Read
                        pCodPersona = Nz(Rs(0)) + 1
                    End While
                Else
                    pCodPersona = 1
                End If
                Rs.Close()
                dt = obj.CasConsulta_ExistePersona(txtUsuario.Text.Trim, "", "", "1", Session("Ruta_Emp"))
                If dt.Rows.Count = 0 Then
                    dt2 = obj.CasConsulta_ExistePersona("", txtNombres.Text.Trim, txtApellidos.Text.Trim, "2", Session("Ruta_Emp"))
                    If dt2.Rows.Count = 1 Then
                        If MsgBox("¿El nombre de usuario ya existe, desea ingresar codigo de Usuario.?", vbQuestion + vbYesNo) = vbYes Then
                            obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "2", Session("Ruta_Emp"))
                            If cboOficina.SelectedValue <> "< Seleccionar >" Then
                                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, cboOficina.SelectedValue.Trim, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "4", Session("Ruta_Emp"))
                            End If
                            If cboPuesto.SelectedValue <> "< Seleccionar >" Then
                                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, cboPuesto.SelectedValue.Trim, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "5", Session("Ruta_Emp"))
                            End If
                            If cboTerrotorio.SelectedValue <> "< Seleccionar >" Then
                                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, cboTerrotorio.SelectedValue.Trim, "6", Session("Ruta_Emp"))
                            End If
                            If txtAntiguedad.Text.Trim <> "" Then
                                pAntiguedad = txtAntiguedad.Text.Trim
                                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", pAntiguedad, 0, "7", Session("Ruta_Emp"))
                            End If
                            If txtBanca.Text.Trim <> "0" Or txtBanca.Text.Trim <> "" Then
                                pBanca = txtBanca.Text.Trim
                                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", pAntiguedad, 0, "8", Session("Ruta_Emp"))
                            End If
                        End If
                    Else
                        obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "2", Session("Ruta_Emp"))
            ...
            Else
                ...
                obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, 0, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "3", Session("Ruta_Emp"))
                If cboOficina.SelectedValue <> "< Seleccionar >" Then
                    obj.InsUpd_Personas(pCodPersona, txtUsuario.Text.Trim, txtNombres.Text.Trim, txtApellidos.Text.Trim, cboOficina.SelectedValue.Trim, 0, txtTelefono.Text.Trim, txtAnexo.Text.Trim, txtCorreo.Text.Trim, pBanca, "", 0, 0, "4", Session("Ruta_Emp"))
                End If
                If cboPuesto.SelectedValue <> "< Seleccionar >" Then
