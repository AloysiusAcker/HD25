<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="CasReporte_IncidentexComponente.aspx.vb" Inherits="CasReporte_IncidentexComponente" title="CAS" %>
            ...
            <tr>
                ...
                <td align="left" style="height: 50px; text-align: center; width: 550px;" valign="top" colspan="1">
                    <div id="lblTitulo" runat="server" class="EstiloTitleMenu" style="font-weight: bold;
                        ...
                        Incidentes por Componentes</div>
                </td>
                <td align="left" style="width: 25px; height: 50px" valign="top">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td align="left" style="height: 22px; width: 550px;" valign="top" colspan="1">
                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                        ...
                        Height="500px" ReportSourceID="CR1" Width="550px" DisplayGroupTree="False" BestFitPage="False" BorderColor="DarkGray" BorderStyle="Outset" BorderWidth="1px" />
                    <CR:CrystalReportSource ID="CR1" runat="server">
                        <Report FileName="C:\Inetpub\wwwroot\WebCas\Reportes\IxC.rpt">
                        </Report>
