<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Cas_Rep_RankingTerritorial.aspx.vb" Inherits="Contabilidad_Rep_RankingTerritorial" title="Untitled Page" %>
    ...
    <div style="text-align: left">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 550px">
            <tr>
                ...
                <td align="left" style="width: 23px; height: 50px" valign="top">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 23px; height: 15px" valign="top">
                </td>
            </tr>
            <tr>
                ...
                <td align="left" style="width: 23px; height: 22px" valign="top">
                </td>
            </tr>
            <tr>
                <td align="left" style="width: 25px; height: 22px" valign="top">
                ...
                <td align="left" style="height: 22px" valign="top">
                    <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True"
                        ...
                        Height="550px" ReportSourceID="RPRankig" Width="500px" />
                    <CR:CrystalReportSource ID="RPRankig" runat="server">
                        <Report FileName="Reportes\Registro_RankingTerritorial.rpt">
                        </Report>
