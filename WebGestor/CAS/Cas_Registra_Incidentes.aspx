<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Cas_Registra_Incidentes.aspx.vb" Inherits="Cas_Registra_Incidentes" title="GestorPlus" %>
            ...
            <tr>
                ...
                <td align="left" colspan="5" style="vertical-align: middle; height: 19px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            <asp:RadioButtonList ID="optIncidente" runat="server" AutoPostBack="True" Font-Names="Arial"
                                Font-Size="8pt" Height="20px" OnSelectedIndexChanged="optIncidente_SelectedIndexChanged"
                                RepeatDirection="Horizontal" Width="284px">
                                <asp:ListItem Selected="True" Value="0">Reportar Incidente</asp:ListItem>
                                <asp:ListItem Value="1">Buscar Incidente Reportado</asp:ListItem>
                            </asp:RadioButtonList>
                        </ContentTemplate>
                    </asp:UpdatePanel>&nbsp;
                    <asp:Button ID="btnBusIncidente" runat="server" BackColor="LightGray"
                        ...
                        onmouseover="this.style.fontWeight='bolder'" Text="Inc. Reportado" Width="106px" /></td>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 90px; height: 22px" valign="top">
                    <asp:Label ID="lbl1" runat="server" Font-Names="Arial" Font-Size="8pt" ForeColor="Red"
                        Text="Nº de Incidente"></asp:Label></td>
                <td align="left" style="vertical-align: middle; width: 60px; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtIncidente" runat="server" Width="60px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" __designer:wfdid="w1" ReadOnly="True"></asp:TextBox>&nbsp; 
</ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged" />
                            <asp:AsyncPostBackTrigger ControlID="cmdLimpiar" EventName="Click" />
...
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" style="vertical-align: middle; width: 100px; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel27" runat="server">
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnDatos" EventName="Click" />
                            <asp:AsyncPostBackTrigger ControlID="txtIncidente" EventName="TextChanged" />
                        </Triggers>
                    </asp:UpdatePanel>
                </td>
                <td align="left" style="width: 25px; height: 22px" valign="top">
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 60px; height: 23px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtUsuario" runat="server" Width="60px" Height="16px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" __designer:wfdid="w2" AutoPostBack="True" MaxLength="7"></asp:TextBox> 
</ContentTemplate>
                        <Triggers>
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
...
<asp:AsyncPostBackTrigger ControlID="btnBuscarInc" EventName="Click"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" colspan="4" style="vertical-align: middle; height: 23px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <asp:Label ID="Label3" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Oficina"
                                Width="45px"></asp:Label><asp:TextBox ID="txtOficina" runat="server" BorderColor="Black"
                                    BorderStyle="Outset" BorderWidth="1px" Font-Names="Arial" Font-Size="8pt" Height="16px"
                                    ReadOnly="True" Width="301px"></asp:TextBox>
                        </ContentTemplate>
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnDatos" EventName="Click" />
            ...
            <tr>
                ...
                <td align="left" colspan="4" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                        <ContentTemplate>
                            <asp:TextBox ID="txtNombre" runat="server" BorderColor="Black" BorderStyle="Outset"
                ...
                <td align="left" colspan="2" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            <asp:Label ID="Label4" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Teléfono"
                                Width="45px"></asp:Label>
                            <asp:TextBox ID="txtTelefono" runat="server" BorderColor="Black" BorderStyle="Outset"
                                BorderWidth="1px" Font-Names="Arial" Font-Size="8pt" Height="16px" ReadOnly="True"
...
<asp:AsyncPostBackTrigger ControlID="btnBuscarInc" EventName="Click"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" colspan="3" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:Label ID="Label10" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Importancia"
            ...
            <tr>
                ...
                <td align="left" colspan="3" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel17" runat="server">
                        <ContentTemplate>
                            <asp:DropDownList ID="cboImportancia" runat="server" AutoPostBack="True" Font-Names="Arial"
                ...
                <td align="left" colspan="3" style="background-color: darkgray; text-align: right;"
                    valign="top">
                        <asp:UpdatePanel ID="UpdatePanel8" runat="server">
                            <ContentTemplate>
<DIV style="BORDER-RIGHT: darkgray 1px outset; BORDER-TOP: darkgray 1px outset; OVERFLOW: auto; BORDER-LEFT: darkgray 1px outset; WIDTH: 890px; BORDER-BOTTOM: darkgray 1px outset; HEIGHT: 452px" id="DIV1" runat="server"><asp:GridView id="Flex" runat="server" Width="1100px" Font-Size="7pt" Font-Names="Arial" PageSize="30" DataKeyNames="CARCON_APLICATIVO,CARCON_PRODUCTO,CARCON_SUBPRODUCTO" AutoGenerateColumns="False" AllowPaging="True"><Columns>
<asp:ButtonField Text="Aceptar" ButtonType="Button" CommandName="Aceptar">
<ControlStyle BackColor="LightGray" BorderStyle="Outset" Width="50px" ForeColor="Gray" BorderWidth="1px" BorderColor="Gray" Font-Size="8pt" Font-Names="Arial"></ControlStyle>
...
<ItemStyle Width="500px" HorizontalAlign="Left" VerticalAlign="Top"></ItemStyle>
                ...
                <tr>
                    <td align="left" colspan="3" style="background-color: darkgray; width: 300px;" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel24" runat="server">
                            <ContentTemplate>
<DIV style="BORDER-RIGHT: darkgray 1px outset; BORDER-TOP: darkgray 1px outset; OVERFLOW: auto; BORDER-LEFT: darkgray 1px outset; WIDTH: 300px; BORDER-BOTTOM: darkgray 1px outset; POSITION: static; HEIGHT: 160px" id="DIV2" runat="server"><asp:GridView id="FlexTI" runat="server" Width="300px" Height="1px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="DarkGray" AutoGenerateColumns="False" PageSize="5"><Columns>
                ...
                <tr>
                    <td align="left" colspan="5" style="height: 19px; background-color: darkgray" valign="top">
                        <asp:UpdatePanel ID="UpdatePanel28" runat="server">
                            <ContentTemplate>
<DIV style="BORDER-RIGHT: darkgray 1px outset; BORDER-TOP: darkgray 1px outset; OVERFLOW: auto; BORDER-LEFT: darkgray 1px outset; WIDTH: 450px; BORDER-BOTTOM: darkgray 1px outset; POSITION: static; HEIGHT: 160px">
    <asp:GridView id="FlexA" runat="server" Width="700px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="DarkGray" AllowPaging="True" AutoGenerateColumns="False" PageSize="30" UseAccessibleHeader="False" Font-Overline="False">
        <Columns>
