<%@ Page Language="VB" MasterPageFile="~/Encuesta/PagPrincipal_Encuenta.master" AutoEventWireup="false" CodeFile="VerResultEncAno.aspx.vb" Inherits="VerResultEncAno" title="Untitled Page" %>
    ...
    <div style="text-align: left">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
            ...
            <tr>
                ...
                <td align="left" style="width: 550px;" valign="top">
                    <div id="lblTitulo2" runat="server" style="font-weight: bold; font-size: 12pt; vertical-align: baseline;
                        width: 549px; color: seagreen; font-family: Arial; height: 32px; text-align: center">
                        Titulo</div>
                </td>
                <td align="left" style="width: 25px;" valign="top">
                </td>
            ...
            <tr>
                ...
                <td align="left" style="width: 550px" valign="top">
                    <asp:Label ID="lblTotalEnc" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="9pt"
                        Height="2px" Visible="False" Width="545px"></asp:Label></td>
                <td align="left" style="width: 25px" valign="top">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" style="width: 550px; height: 19px" valign="top">
                    <asp:HyperLink ID="Cancelar" runat="server" Font-Names="Arial" Font-Size="9pt" Font-Underline="False"
                       onmouseover="this.style.fontWeight='bolder'" onmouseout="this.style.fontWeight='normal'"  ForeColor="Gray" Height="22px" NavigateUrl="Encuestas_Anonimos.aspx" Font-Italic="True">Continuar</asp:HyperLink></td>
                <td align="left" style="width: 25px; height: 19px" valign="top">
                </td>
            </tr>
        </table>
