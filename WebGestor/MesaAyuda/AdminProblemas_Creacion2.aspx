<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="AdminProblemas_Creacion2.aspx.vb" Inherits="AdminProblemas_Creacion2" title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: left">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
            ...
            <tr>
                <td align="left" colspan="5" style="height: 11px; background-image: url(../Fotos/lineaCas.JPG);" valign="top">
                    </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" colspan="3" style="height: 19px" valign="top">
                    <div id="DIV1" runat="server" style="border-right: gray 1px outset; border-top: gray 1px outset;
                        ...
                        height: 186px">
                        <asp:GridView ID="FlexProb" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            Font-Names="Arial" Font-Size="8pt" PageSize="5">
                            <Columns>
                                <asp:ButtonField ButtonType="Button" CommandName="Mostrar" Text="Mostrar">
                                    <ControlStyle BackColor="Silver" BorderColor="Gray" BorderStyle="Outset" BorderWidth="1px"
                                        Font-Names="Arial" Font-Size="8pt" ForeColor="Gray" Width="60px" />
                                </asp:ButtonField>
                                <asp:BoundField DataField="APROB_CODIGO" HeaderText="N&#186; Probl." />
                                <asp:BoundField DataField="APROB_FECHA_REPORTA" HeaderText="Fecha Reporta" />
                                <asp:BoundField DataField="APROB_HORA_REPORTA" HeaderText="Hora Reporta" />
                                <asp:BoundField DataField="NIVEL1_DESCRIP" HeaderText="Tipo Problema" />
                                <asp:BoundField DataField="APROB_FECHA_VISTO" HeaderText="Fecha Visto" />
                                <asp:BoundField DataField="APROB_HORA_VISTO" HeaderText="Hora Visto" />
                                <asp:BoundField DataField="APROB_FECHA_ASIGNADO" HeaderText="Fecha Asig." />
                                <asp:BoundField DataField="APROB_HORA_ASIGNADO" HeaderText="Hora Asig." />
                                <asp:BoundField DataField="PERSON_ASIG1" HeaderText="Persona Asig." />
                                <asp:BoundField DataField="APROB_FECHA_ASIGVISTO" HeaderText="Fecha Asig. Visto" />
                                <asp:BoundField DataField="APROB_HORA_ASIGVISTO" HeaderText="Hora Asig. Visto" />
                                <asp:BoundField DataField="APROB_FECHA_SOLUCION" HeaderText="Fecha Sol." />
                                <asp:BoundField DataField="APROB_HORA_SOLUCION" HeaderText="Hora Sol." />
                                <asp:BoundField DataField="PESTADO" HeaderText="Estado" />
                                <asp:BoundField DataField="APROB_PRIORIDAD" HeaderText="Prior." />
                                <asp:BoundField DataField="NOM_PROB1" HeaderText="Concepto Problema" />
                                <asp:BoundField DataField="APROB_PROBLEMA_DESCRIPCION" HeaderText="Descripci&#243;n Problema" />
                                <asp:BoundField DataField="ECONFORME" Visible="False" />
                                <asp:BoundField DataField="NOM_PROB_ORIG" Visible="False" />
                                <asp:BoundField DataField="NOM_PROB_ORIG1" Visible="False" />
                                <asp:BoundField DataField="COLOR_ROJO" Visible="False" />
                                <asp:BoundField DataField="COLOR_VERDE" Visible="False" />
                                <asp:BoundField DataField="COLOR_AZUL" Visible="False" />
                                <asp:BoundField DataField="PERSONAL1" HeaderText="Persona Report&#243;" />
                                <asp:BoundField DataField="APROB_ASIGNADO_PERSONA" Visible="False" />
                                <asp:BoundField DataField="APROB_ESTADO" Visible="False" />
                                <asp:BoundField HeaderText="Comformidad x Persona que Reporta" />
                                <asp:BoundField HeaderText="Tipo de Problema Real" />
                                <asp:BoundField HeaderText="Concepto Problema Real" />
                                <asp:TemplateField HeaderText="Visto">
                                    <ItemTemplate>
