...
Imports WebGestor
Imports System.Data
Partial Class AdminProblemas_Creacion21
...
#End Region
    ...
    Private Function Carga_Problemas() As ICollection
        ...
        If chk5.Checked = True Then
            ...
            SqlEst = SqlEst & "APROB_ESTADO='5'"
        End If
        If SqlEst = "" Then lblMensaje.Text = "No hay estado de problema marcado, favor de hacerlo para poder listar." : Return "" : Exit Function
        Dim Cn As New SqlConnection(Session("Ruta_Emp"))
        Dim Rs As SqlDataReader
        Dim bolError As Boolean
        Dim i As Integer
