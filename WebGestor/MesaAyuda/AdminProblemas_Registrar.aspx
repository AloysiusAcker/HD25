<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="AdminProblemas_Registrar.aspx.vb" Inherits="AdminProblemas_Registrar" title="Mesa de Ayuda - Registrar" %>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 60px; height: 23px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel16" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtUsuario" runat="server" Width="60px" Height="16px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" __designer:wfdid="w2" AutoPostBack="True" MaxLength="8"></asp:TextBox> 
</ContentTemplate>
                        <Triggers>
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
