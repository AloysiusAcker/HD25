...
Partial Class AdminProblemas_Registrar
        ...
        Try
            If optIncidente.SelectedIndex = 0 Then
                ...
                If cboOficina.SelectedValue <> "< Seleccionar >" And cboOficina.SelectedIndex <> -1 And lblCodOficina.Text <> "" Then
                    obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "2", cboOficina.SelectedValue.Trim, txtTelefono.Text.Trim, "", "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                Else
                    obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "2", lblCodOficina.Text, txtTelefono.Text.Trim, "", "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                End If
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            Page.Title = "Mesa de Ayuda - Registrar"
            Try
