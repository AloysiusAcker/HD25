...
Imports System.Data
Partial Class AdminProblemas_Lista_Enlace_TemasAyuda
    ...
    Private Sub Llenar_Grilla_TA()
        Try
            ...
            dtListado = obj.MALista_TemaAyuda(Session("Ruta_Emp"), Session("CodEmpresa"))
    ...
    Private Sub Llenar_Grilla()
        Try
            ...
            For i = 0 To Flex.Rows.Count - 1
                ...
                dtListado = obj.CasLista_Enlace(pCodigo)
                If dtListado.Rows.Count > 0 Then
                    For Each drMenuItem As Data.DataRow In dtListado.Rows
                        Fila = Flex.Rows(i)
