<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="AdminProblemas_Registrar_Usuario.aspx.vb" Inherits="AdminProblemas_Registrar_Usuario" title="Mesa de Ayuda - Registrar Usuario" %>
            ...
            <tr>
                ...
                <td align="left" style="height: 19px" valign="top" colspan="5">
                    <asp:UpdatePanel ID="UpdatePanel33" runat="server">
                        <ContentTemplate>
<asp:Label id="lblMensaje" runat="server" Font-Italic="False" Font-Size="16pt" Font-Names="Arial" Font-Bold="True" ForeColor="Maroon" __designer:wfdid="w15"></asp:Label> 
</ContentTemplate>
                        <Triggers>
            ...
            <tr>
                ...
                <td align="left" colspan="7" valign="top">
                    <asp:UpdatePanel id="UpdatePanel34" runat="server">
                        <contenttemplate>
<asp:Label id="lblErrorInc" runat="server" Font-Size="8pt" Font-Names="Arial" ForeColor="Red" __designer:wfdid="w17"></asp:Label> 
</contenttemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="cmdResolver" EventName="Click"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" colspan="5" style="vertical-align: middle; height: 19px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel21" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
<asp:RadioButtonList id="optIncidente" runat="server" Width="284px" Height="20px" Font-Size="8pt" Font-Names="Arial" AutoPostBack="True" __designer:wfdid="w3" OnSelectedIndexChanged="optIncidente_SelectedIndexChanged" RepeatDirection="Horizontal"><asp:ListItem Selected="True" Value="0">Reportar Problemae</asp:ListItem>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 60px; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel15" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtIncidente" runat="server" Width="60px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" ReadOnly="True" __designer:wfdid="w6"></asp:TextBox> 
</ContentTemplate>
                        <Triggers>
...
<asp:AsyncPostBackTrigger ControlID="cmdLimpiar" EventName="Click"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" colspan="3" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel32" runat="server">
                        <ContentTemplate>
<asp:Button id="btnBuscarInc" runat="server" Width="20px" Height="20px" Text="..." BorderWidth="1px" BorderStyle="Outset" BorderColor="Gray" BackColor="LightGray" __designer:wfdid="w7"></asp:Button> 
</ContentTemplate>
                        <Triggers>
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
</Triggers>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 60px; height: 23px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel40" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtUsuario" runat="server" Width="60px" Height="16px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" __designer:wfdid="w8" AutoPostBack="True" ReadOnly="True" MaxLength="8"></asp:TextBox> 
</ContentTemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="btnBuscarInc" EventName="Click"></asp:AsyncPostBackTrigger>
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" style="vertical-align: middle; width: 30px; height: 23px; text-align: right"
                    ...
                    <asp:Button ID="btnDatos" runat="server"
                                    ...
                                    Height="20px" Text="..." Width="20px" Enabled="False" />&nbsp;&nbsp;</td>
                <td align="left" colspan="4" style="vertical-align: middle; height: 23px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel41" runat="server">
                        <ContentTemplate>
<asp:TextBox id="txtNombre" runat="server" Width="346px" Height="16px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="Black" ReadOnly="True" __designer:wfdid="w9"></asp:TextBox> 
</ContentTemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="btnBuscarInc" EventName="Click"></asp:AsyncPostBackTrigger>
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" colspan="7" style="vertical-align: middle;" valign="top">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 550px; height: 24px;">
                                ...
                                <tr>
                                    <td align="left" style="width: 50px; height: 25px; vertical-align: middle;" valign="top">
                                        <asp:Label ID="Label2" runat="server" Font-Names="Arial" Font-Size="8pt" Text="Archivo"
                                            Width="40px"></asp:Label></td>
                                    <td align="left" style="vertical-align: middle; width: 500px; height: 25px" valign="top">
                        <asp:FileUpload ID="FileUpload1" runat="server" Visible="true" Font-Names="Arial" Font-Size="8pt" Width="480px" /></td>
                                </tr>
                                <tr>
            ...
            <tr>
                ...
                <td align="left" colspan="7" style="vertical-align: middle;" valign="top">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 550px">
                        <tr>
                            <td align="left" style="width: 50px; height: 95px;" valign="top">
...
<asp:AsyncPostBackTrigger ControlID="txtIncidente" EventName="TextChanged"></asp:AsyncPostBackTrigger>
                            ...
                            <td align="left" style="width: 500px; height: 95px;" valign="top">
...
<asp:AsyncPostBackTrigger ControlID="btnBuscarInc" EventName="Click"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" colspan="7" style="vertical-align: middle; height: 25px; text-align: center"
                    valign="top">
                    &nbsp;<asp:Button ID="cmdResolver" runat="server" BackColor="LightGray" BorderColor="Gray"
                        BorderStyle="Outset" BorderWidth="1px" CssClass="EstiloBoton" EnableTheming="True"
                        Font-Names="Arial" Font-Size="8pt" ForeColor="Gray" onmouseout="this.style.fontWeight='normal'"
                        onmouseover="this.style.fontWeight='bolder'" Text="Resolver" Width="85px" />
...
<asp:AsyncPostBackTrigger ControlID="optIncidente" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" style="width: 25px;" valign="top">
                    ...
                    <asp:Panel ID="panelUpdateProgress" runat="server" Width="200px" CssClass="updateProgress" style="left: 88px; top: -22px">
                    ...
                    <cc1:ModalPopupExtender ID="ModalProgress" runat="server" TargetControlID="panelUpdateProgress"
                        ...
                        <asp:Button ID="btnUpload" runat="server" Text="Subir Archivo" OnClick="btnUpload_Click" Visible="False" BackColor="LightGray" BorderColor="Gray" BorderStyle="Outset" BorderWidth="1px" CssClass="EstiloBoton" Font-Names="Arial" Font-Size="8pt" ForeColor="Gray" Width="88px" />
        &nbsp;
    </div>
