...
Partial Class AdminProblemas_Creacion
...
#End Region
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load, Me.Load
        ...
        If Not Page.IsPostBack Then
            Page.Title = "Mesa de Ayuda - Listado"
    ...
    Private Function Carga_Problemas() As ICollection
        ...
        Try
            ...
            Dim Sql As String = "SELECT APROB_USUARIO_REPORTA,(SELECT PERSON_APEPAT + ' ' + PERSON_APEMAT + ', ' + PERSON_NOMBRES From BDGRUPOEMPRESAS.dbo.TBPERSONAL WHERE PERSON_CODIGO = APROB_USUARIO_REPORTA) AS PERSONAL1," _
                              ...
                              & "(SELECT ELEMEN_VALOR FROM BDGRUPOEMPRESAS.DBO.TBCELEMEN WHERE ELEMEN_CODIGO=APROB_CONFORMIDAD_USUARIOREP AND ELEMEN_TABLA='TBOPC057') AS ECONFORME, APROB_ASIGNADO_PERSONA, " _
                              & "(SELECT USUARI_APEPAT + ' ' + USUARI_APEMAT + ', ' + USUARI_NOMBRES From BDSEGURIDADGRUPOEMPS.DBO.TBUSUARI WHERE USUARI_CODIGO = APROB_ASIGNADO_PERSONA AND USUARI_SYS_EST = '0') AS PER_ASIGNADO  " _
            ...
            If Rs.HasRows Then
                While Rs.Read
                    ...
                    dr("c19") = Nu(Rs!PER_ASIGNADO)
                    dr("c20") = Nu(Rs!APROB_ASIGNADO_PERSONA)
                    dt.Rows.Add(dr)
                End While
    ...
    Protected Sub FlexProb_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FlexProb.RowCommand
        ...
        Try
            ...
            If e.CommandName = "Asignar" Then
                ...
                If FlexProb.Rows(Index).Cells(19).Text = "1" And FlexProb.Rows(Index).Cells(20).Text = "0" Then
                    obj.MAUpdate_xProblemaNoVisto(Session("Ruta_Emp"), Session("CodEmpresa"), pdCodProb, FechaActual, HoraActual)
                End If
            ...
            If e.CommandName = "Aplicar" Then
                ...
                If FlexProb.Rows(Index).Cells(22).Text <> lblUsuarioCodigo.Text Then lblMensaje2.Text = "Ud. no puede Aplicar una Acción debido que el problema está asignado a otro usuario." : Exit Sub
                lblErrorAcc.Text = ""
                Ficha.ActiveTabIndex = 0 : Ficha.ActiveTab.Enabled = False
                Ficha.ActiveTabIndex = 1 : Ficha.ActiveTab.Enabled = False
                ...
                txtPerCodigoAcc.Text = lblUsuarioCodigo.Text
                ...
                For Each dr As DataRow In dt.Rows
                    If Nu(dr("APROB_ASIGNADO_PERSONA")) <> cboPersonal.SelectedValue.Trim Then
                        ...
                        If cboPersonal.SelectedValue.Trim = User.Identity.Name Then
                            CmdGlobal.CommandText = "UPDATE TBADMIN_PROBLEMAS SET APROB_ESTADO='4',APROB_FECHA_ASIGVISTO='" & FechaActual() & "', APROB_HORA_ASIGVISTO='" & HoraActual() & "' WHERE APROB_CODIGO=" & pdCodProb & " AND EMPRESA_CODIGO='" & Session("CodEmpresa") & "'"
...
'
    ...
    Protected Sub btnGuardarItem_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            End If
            'Call LLena_Item_Tipo_Prob(lblTipoProb.Text, "1", cboAccion)
            'Call LLena_Item_Tipo_Prob(lblTipoProb.Text, "2", cboCausa)
    ...
    Protected Sub btnGuadar2_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            obj.MAInsert_ProblemaDetalle(Session("CodEmpresa"), Session("Ruta_Emp"), pdCodProb, psAccion, _
                                         ...
                                         Session("User"), psEstado, pdTipoProb1, pdTipoProb2, pdTipoProb3, "", "")
            Ficha.ActiveTabIndex = 1 : Ficha.ActiveTab.Enabled = False
            Ficha.ActiveTabIndex = 2 : Ficha.ActiveTab.Enabled = False
            Ficha.ActiveTabIndex = 0 : Ficha.ActiveTab.Enabled = True
    ...
    Protected Sub btnExportar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnExportar.Click
        ...
        'FlexProb.EnableViewState = False
        'pagina.EnableEventValidation = False
        'pagina.DesignerInitialize()
        'pagina.Controls.Add(form)
        'form.Controls.Add(FlexProb)
        'pagina.RenderControl(htw)
        'Response.Clear()
        'Response.Buffer = True
        'Response.ContentType = "application/vnd.ms-excel"
        'Response.AddHeader("Content-Disposition", "attachment;filename=Mesa de Ayuda Listado.xls")
