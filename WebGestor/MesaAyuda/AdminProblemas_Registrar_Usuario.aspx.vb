...
Partial Class AdminProblemas_Registrar_Usuario
    ...
    Protected Sub optIncidente_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        If optIncidente.SelectedIndex = 0 Then
            ...
            txtUsuario.Focus()
            txtUsuario.Text = Session("User")
            txtNombre.Text = Session("UserNombreInicio")
        ...
        Try
            If optIncidente.SelectedIndex = 0 Then
               ...
               If cboImportancia.SelectedValue = "< Seleccionar >" Or cboImportancia.SelectedIndex = -1 Then lblErrorInc.Text = "Es necesario saber la Prioridad del Problema" : Exit Sub
                ...
                obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "1", 0, "", "", "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "2", 0, "", "", "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "3", 0, "", pEstado, "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                If pEstado = "1" Or pEstado = "10" Then
                    obj.MAInsUpd_ProblemaDetalle(Session("CodEmpresa"), pCodIncidente, txtSolucion.Text.Trim, Session("User"), "1", "", "", Session("Ruta_Emp"))
                    obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "4", 0, "", pEstado, "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                ElseIf pEstado = "5" Or pEstado = "4" Then
                    obj.MAUpdate_xProblemaNoVisto(Session("Ruta_Emp"), Session("CodEmpresa"), pCodIncidente, FechaActual, HoraActual)
                    obj.MAInsert_ProblemaAsignado(Session("Ruta_Emp"), Session("CodEmpresa"), pCodIncidente, Session("User"), FechaActual, HoraActual, pEstado, FechaActual, HoraActual, Session("User"))
                    obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, Tipo2, Tipo3, txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "5", 0, "", pEstado, pAsignado, pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                    obj.MAInsUpd_ProblemaDetalle(Session("CodEmpresa"), pCodIncidente, txtSolucion.Text.Trim, Session("User"), "2", "", "", Session("Ruta_Emp"))
                End If
            ...
            Else
                ...
                If lblCodEstado.Text.Trim <> "2" And lblCodEstado.Text.Trim <> "5" And lblCodEstado.Text.Trim <> "6" And lblCodEstado.Text.Trim <> "10" Then
                    obj.MAInsUpd_Problema(Session("CodEmpresa"), pCodComponente, Session("User"), txtUsuario.Text.Trim, pCodIncidente, cboImportancia.SelectedValue.Trim, "", "", txtDescripcion.Text.Trim, cboTipo.SelectedValue.Trim, "6", 0, "", lblCodEstado.Text, "", pIniLlamada, "0", "", "", "", "", "", Session("Ruta_Emp"))
                Else
    ...
    Protected Sub cmdResolver_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmdResolver.Click
        ...
        psBody = psBody & "<br> Fecha y Hora: " & FormatoFecha(FechaActual) & " - " & FormatoHora(HoraActual)
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            Page.Title = "Mesa de Ayuda - Registrar Usuario"
            Try
    ...
    End Sub
    Protected Sub btnNotificar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim pCorreo As String
        Dim psBody As String = ""
        lblMensaje.Text = ""
        If txtUsuario.Text.Trim = "" Or txtNombre.Text.Trim = "" Then lblErrorInc.Text = "Ingresar Usuario que Reporta del Incidente." : Exit Sub
        ...
        psBody = psBody & "<br> Fecha y Hora: " & FormatoFecha(FechaActual) & " - " & FormatoHora(HoraActual)
        psBody = psBody & "<br> Usuario que reporta: " & txtNombre.Text.Trim
        psBody = psBody & "<br> Tipo de Incidente: " & cboComponente.Text
        If cboElemento.SelectedValue.Trim <> "< Seleccionar >" Then psBody = psBody & " - " & cboElemento.Text
        If cboElemento2.SelectedValue.Trim <> "< Seleccionar >" Then psBody = psBody & " - " & cboElemento2.Text
        psBody = psBody & "<br> Descripción: " & txtDescripcion.Text.Trim
        psBody = psBody & "<br> Solución: " & txtSolucion.Text.Trim
        psBody = psBody & "<br> Archivo Adjunto: " & FileUpload1.FileName
