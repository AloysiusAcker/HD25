<%@ Page Language="VB" MasterPageFile="~/CallCenter/PagPrincipal_Call.master" AutoEventWireup="false" CodeFile="CallCenter_CargaDatos.aspx.vb" Inherits="CallCenter_CallCenter_CargaDatos" title="Untitled Page" %>
    ...
    <div style="text-align: left">
        <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
            ...
            <tr>
                ...
                <td align="left" colspan="1" style="vertical-align: middle; width: 460px; height: 22px"
                    valign="top">
            ...
            <tr>
                ...
                <td align="left" colspan="1" style="vertical-align: middle; width: 460px; height: 22px;
                    ...
                    <asp:Button ID="btnArchExcel" runat="server" BackColor="LightGray" BorderColor="Gray"
                        ...
                        Text="Importar Arch. Excel" Width="146px" /></td>
                <td align="left" style="width: 25px; height: 22px" valign="top">
                </td>
            </tr>
            <tr>
                ...
                <td align="left" colspan="2" style="vertical-align: middle" valign="top">
            ...
            <tr>
                ...
                <td align="left" style="width: 460px; height: 19px" valign="top">
                </td>
                <td align="left" style="width: 25px; height: 19px" valign="top">
                </td>
            </tr>
