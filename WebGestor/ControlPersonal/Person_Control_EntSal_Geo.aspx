<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Person_Control_EntSal_Geo.aspx.vb" Inherits="ControlPersonal_Person_Control_EntSal_Geo" %>

    <%@ Register Src="~/CMenuLeft.ascx" TagPrefix="uc1" TagName="CMenuLeft" %>
<!DOCTYPE html>
...
<%--    <meta name="HandheldFriendly" content="true" />--%>
    ...
    <link  href="Css_Tab.css" rel ="stylesheet"  />
...
<body>
                    ...
                    <div class="navbar-header" style="width: 100%">
                        ...
                        <a href="#" class="navbar-brand"><img src="~/Fotos/logo_white.png" runat="server"
                            ...
                            <ul id="nav-mobile" class="nav navbar-nav navbar-right" style="float:right; margin: 0px;">
                                <li><asp:LinkButton ID="Inicio" runat="server" PostBackUrl="~/Default4.aspx" >Inicio</asp:LinkButton></li>
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="container">
                    ...
                    <br />
                    <input type="text" id="txtGeoInfo" class="form-control" />
                </div> 
            </div>
        </div>
        <footer class="footer">
    ...
    <!-- Agregar el script para obtener la geolocalización -->
        <script type="text/javascript">
            function obtenerGeolocalizacion() {
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        function (position) {
                            // Mostrar la información de geolocalización en la caja de texto
                            var geoInfo = "Latitud: " + position.coords.latitude + ", Longitud: " + position.coords.longitude;
                            document.getElementById("txtGeoInfo").value = geoInfo;
                        },
                        function (error) {
                            console.log(error);
