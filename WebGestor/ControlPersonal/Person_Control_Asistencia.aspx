<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Person_Control_Asistencia.aspx.vb" Inherits="ControlPersonal_Person_Control_Asistencia" %>
    ...
    <script type="text/javascript">
       ...
       let stream = null; // Variable global para almacenar el flujo de la cámara
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <asp:Label ID="LblEtiq1" runat="server" Text="Asistencia" CssClass="Titulos" />
                </div> 
            </div>
