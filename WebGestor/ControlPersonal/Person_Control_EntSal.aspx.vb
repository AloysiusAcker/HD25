...
Partial Class Person_Control_EntSal
    ...
    Private Sub ListaPersonal()
        ...
        FlexBus.DataSource = obj.Listar_Personal(Session("CodGrupoEmpresa"), Session("CodEmpresa"))
        FlexBus.DataBind()
    End Sub
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        End If
    End Sub
    Protected Sub FlexBus_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FlexBus.RowCommand
        ...
        If e.CommandName = "Aceptar" Then
            ...
            txtCodigo.Text = FlexBus.Rows(Index).Cells(1).Text
    ...
    Protected Sub btnGrabar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGrabar.Click
        ...
        Response.Redirect("Person_Control_Entsal.aspx")
    End Sub
