...
Partial Class Eventos_Permisos
    ...
    Private Sub BtnGuardar_Click(sender As Object, e As EventArgs) Handles BtnGuardar.Click
        ...
        '    ScriptManager.RegisterStartupScript(Me, Me.Page.GetType, "", "alert('Ingresar Hora que inicia el permiso');", True)
        'End If
        'If TxtHoraFin.Text = "" Then
        '    ScriptManager.RegisterStartupScript(Me, Me.Page.GetType, "", "alert('Ingresar Hora que termina el persmiso');", True)
        'End If
        If TxtPerMotivo.Text = "" Then
