...
Imports System.Data
Partial Class Inventario_GuiaRemision_Admin
    ...
    Protected Sub Flex_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles Flex.RowCommand
        ...
        If e.CommandName = "IngEstado" Then
            Try
                If Flex.Rows(Index).Cells(18).Text = "2" Then lblError.Text = "Ya se entregó el Pedido." : Exit Sub
                If Flex.Rows(Index).Cells(18).Text = "3" Then lblError.Text = "El Pedido ha sido rechazado." : Exit Sub
                If Flex.Rows(Index).Cells(18).Text = "8" Then lblError.Text = "El Pedido no ha sido entregado." : Exit Sub
                Flex.Enabled = False
                txtPerAsignada.Text = ""
                txtHora.Text = ""
                txtFecReprog1.Text = ""
                ...
                txtCodGuia.Text = Flex.Rows(Index).Cells(16).Text
                txtSerieGuia.Text = Flex.Rows(Index).Cells(8).Text.Replace("&nbsp;", "")
                txtNroGuia.Text = Flex.Rows(Index).Cells(9).Text.Replace("&nbsp;", "")
                txtDestinatario.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Flex.Rows(Index).Cells(12).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
                txtCodDestino.Text = Flex.Rows(Index).Cells(11).Text.Replace("&nbsp;", "")
                txtEstado.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Flex.Rows(Index).Cells(3).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
                txtCodPedido.Text = Flex.Rows(Index).Cells(17).Text
                txtCodEstado.Text = Flex.Rows(Index).Cells(18).Text
                txtCodCurrier.Text = Flex.Rows(Index).Cells(22).Text
    ...
    Protected Sub btnGuardar_Command(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.CommandEventArgs) Handles btnGuardar.Command
