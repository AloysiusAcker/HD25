<%@ Page Language="VB" MasterPageFile="~/OperadorLogistico/PagPrincipal_Oplogistico.master" AutoEventWireup="false" CodeFile="Inventario_GuiaRemision_CargaArch.aspx.vb" Inherits="Inventario_GuiaRemision_CargaArch" title="Untitled Page" %>
<script runat="server" >
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
                ...
                <tr>
                    ...
                    <td align="left" colspan="2" style="vertical-align: middle; height: 22px; text-align: left"
                        valign="top">
                        <asp:TextBox ID="txtFecha" runat="server" Font-Names="Arial" Font-Size="8pt" Width="90px"></asp:TextBox></td>
                    <td align="left" style="vertical-align: middle; width: 100px; height: 22px; text-align: left"
                        valign="top">
                        <asp:TextBox ID="txtFechaFin" runat="server" Font-Names="Arial" Font-Size="8pt" Width="90px"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td align="left" colspan="6" style="vertical-align: middle; height: 19px" valign="top">
