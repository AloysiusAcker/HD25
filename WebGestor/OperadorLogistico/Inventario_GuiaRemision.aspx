<%@ Page Language="VB" MasterPageFile="~/OperadorLogistico/PagPrincipal_Oplogistico.master" AutoEventWireup="false" CodeFile="Inventario_GuiaRemision.aspx.vb" Inherits="Inventario_GuiaRemision" title="Untitled Page" %>
        ...
        <div style="text-align: left">
            <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
                ...
                <tr>
                    ...
                    <td align="left" style="vertical-align: middle; height: 22px; text-align: left"
                    ...
                    <td align="left" style="vertical-align: middle; width: 115px; height: 22px; text-align: right"
                        ...
                        <asp:Button ID="btnExportar" runat="server" BackColor="LightGray" BorderColor="Gray"
                            ...
                            Text="Exportar" Width="70px" /><asp:Button ID="btnListar" runat="server" BackColor="LightGray" BorderColor="Gray"
                            BorderStyle="Outset" BorderWidth="1px" Font-Names="Arial" Font-Size="8pt" ForeColor="Gray"
                ...
                <tr>
                    ...
                    <td align="left" style="vertical-align: middle; width: 80px; height: 22px; text-align: left"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel7" runat="server">
                            <ContentTemplate>
<asp:TextBox id="txtCurrierRuc" runat="server" Width="77px" Font-Size="8pt" Font-Names="Arial"></asp:TextBox> 
</ContentTemplate>
                            <Triggers>
<asp:AsyncPostBackTrigger ControlID="FlexCurrier" EventName="RowCommand"></asp:AsyncPostBackTrigger>
                    ...
                    <td align="left" colspan="3" style="vertical-align: middle; height: 22px; text-align: left"
                        ...
                        <asp:UpdatePanel ID="UpdatePanel6" runat="server">
                            <ContentTemplate>
<asp:TextBox id="txtCurrierRS" runat="server" Width="350px" Font-Size="8pt" Font-Names="Arial"></asp:TextBox> 
</ContentTemplate>
                            <Triggers>
<asp:AsyncPostBackTrigger ControlID="FlexCurrier" EventName="RowCommand"></asp:AsyncPostBackTrigger>
</Triggers>
...
<asp:AsyncPostBackTrigger ControlID="FlexCurrier" EventName="RowCommand"></asp:AsyncPostBackTrigger>
                ...
                <tr>
                    ...
                    <td align="left" colspan="6" style="vertical-align: middle; height: 22px; text-align: center"
                        valign="top">
                    </td>
                    <td align="left" style="width: 25px; height: 22px" valign="top">
                    </td>
...
<asp:BoundField DataField="PEDIDO_PRIORIDAD" HeaderText="Prioridad">
...
<HeaderStyle ForeColor="White" Width="0px"></HeaderStyle>
</asp:BoundField>
<asp:BoundField DataField="PEDIDO_CONTACTO" HeaderText="Persona Contacto">
...
<asp:AsyncPostBackTrigger ControlID="btnGuardar" EventName="Click"></asp:AsyncPostBackTrigger>
                ...
                <tr>
                    <td align="left" style="width: 25px; height: 473px;" valign="top">
                    </td>
                    <td align="left" colspan="6" valign="top" style="height: 473px">
                        <div style="text-align: left">
...
<TABLE style="WIDTH: 550px" id="lblEstEnProceso" cellSpacing=0 cellPadding=0 border=0 runat="server" Visible="false"><TBODY><TR><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px; HEIGHT: 17px" vAlign=top align=left><asp:Label id="lblEt12" runat="server" Width="69px" Font-Size="8pt" Font-Names="Arial" Text="Persona Asig."></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 330px; HEIGHT: 17px" vAlign=top align=left><asp:TextBox id="txtPerAsignada" runat="server" Width="319px" Font-Size="8pt" Font-Names="Arial"></asp:TextBox></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 40px; HEIGHT: 17px" vAlign=top align=left><asp:Label id="lblEt13" runat="server" Width="30px" Font-Size="8pt" Font-Names="Arial">Hora</asp:Label></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 100px; HEIGHT: 17px" vAlign=top align=left><asp:TextBox id="txtHora" runat="server" Width="90px" Font-Size="8pt" Font-Names="Arial" MaxLength="5"></asp:TextBox></TD></TR></TBODY></TABLE><DIV style="TEXT-ALIGN: left"><TABLE style="WIDTH: 550px" id="lblEstEntrega" cellSpacing=0 cellPadding=0 border=0 runat="server" Visible="false"><TBODY><TR><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px; HEIGHT: 20px" vAlign=top align=left><asp:Label id="lblEt14" runat="server" Width="71px" Font-Size="8pt" Font-Names="Arial" Text="Fecha Entrega"></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 155px; HEIGHT: 20px" vAlign=top align=left><asp:TextBox id="txtFecReprog1" runat="server" Width="145px" Font-Size="8pt" Font-Names="Arial" ReadOnly="True"></asp:TextBox></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px; HEIGHT: 20px" vAlign=top align=left><asp:Label id="lblEt15" runat="server" Width="80px" Font-Size="8pt" Font-Names="Arial" Text="N° Liquidación"></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 235px; HEIGHT: 20px" vAlign=top align=left><DIV style="TEXT-ALIGN: left"><TABLE style="WIDTH: 235px" cellSpacing=0 cellPadding=0 border=0><TBODY><TR><TD style="WIDTH: 80px" vAlign=top align=left><asp:TextBox id="txtCodLiquida" runat="server" Width="68px" Font-Size="8pt" Font-Names="Arial" MaxLength="5"></asp:TextBox></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 50px" vAlign=top align=left><asp:Label id="lblEtqPai" runat="server" Width="44px" Font-Size="8pt" Font-Names="Arial" Text="Llamó al"></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; WIDTH: 105px" vAlign=top align=left><asp:DropDownList id="cboPai101" runat="server" Width="105px" Font-Size="8pt" Font-Names="Arial"></asp:DropDownList></TD></TR></TBODY></TABLE></DIV></TD></TR><TR><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px; HEIGHT: 19px" vAlign=top align=left><asp:Label id="lblEt16" runat="server" Font-Size="8pt" Font-Names="Arial" Text="Hora Entrega"></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; HEIGHT: 19px" vAlign=top align=left colSpan=3><asp:TextBox id="txtHoraReprog" runat="server" Width="464px" Font-Size="8pt" Font-Names="Arial" ReadOnly="True" MaxLength="250" TextMode="MultiLine"></asp:TextBox></TD></TR><TR><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px; HEIGHT: 19px" vAlign=top align=left><asp:Label id="lblEt17" runat="server" Font-Size="8pt" Font-Names="Arial" Text="Tipo Obs."></asp:Label></TD><TD style="VERTICAL-ALIGN: middle; HEIGHT: 19px" vAlign=top align=left colSpan=3><asp:DropDownList id="cboTipoObs" runat="server" Width="470px" Font-Size="8pt" Font-Names="Arial"></asp:DropDownList></TD></TR><TR><TD style="VERTICAL-ALIGN: middle; WIDTH: 80px" vAlign=top align=left><asp:Label id="lblEt18" runat="server" Font-Size="8pt" Font-Names="Arial" Text="Observación"></asp:Label></TD><TD vAlign=top align=left colSpan=3><asp:TextBox id="txtObs" runat="server" Width="464px" Height="61px" Font-Size="8pt" Font-Names="Arial" MaxLength="250" TextMode="MultiLine" ToolTip="Máximo 250 caracteres"></asp:TextBox></TD></TR><TR><TD style="WIDTH: 80px; HEIGHT: 19px" vAlign=top align=left></TD><TD style="WIDTH: 155px; HEIGHT: 19px" vAlign=top align=left><asp:TextBox id="txtCodPedido" runat="server" Width="56px" Font-Size="8pt" Font-Names="Arial" Visible="False"></asp:TextBox></TD><TD style="WIDTH: 80px; HEIGHT: 19px" vAlign=top align=left><asp:TextBox id="txtCodEstado" runat="server" Width="37px" Visible="False"></asp:TextBox></TD><TD style="WIDTH: 235px; HEIGHT: 19px" vAlign=top align=left><asp:TextBox id="txtCodCurrier" runat="server" Width="40px" Font-Size="8pt" Font-Names="Arial" Visible="False"></asp:TextBox></TD></TR></TBODY></TABLE></DIV><cc1:CalendarExtender id="CalendarExtender2" runat="server" TargetControlID="txtFecReprog1" Format="dd/MM/yyyy" PopupButtonID="txtFecReprog1"></cc1:CalendarExtender> 
</ContentTemplate>
<Triggers>
