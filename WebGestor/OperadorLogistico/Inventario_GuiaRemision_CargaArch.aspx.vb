...
Imports System.Data
Partial Class Inventario_GuiaRemision_CargaArch
    ...
    Private Sub Llenar_Grilla()
        ...
        Try
            dtListado = obj.Lista_GuiaArchivoxCourier(Session("Ruta_Emp"), Session("CodEmpresa"), FechaEntrega, HttpContext.Current.User.Identity.Name, FechaFin)
