...
Imports System.Data
Partial Class Inventario_GuiaRemision_Update
    ...
    Private Sub Llenar_Grilla()
        ...
        If txtCurrierRuc.Text <> "" Then
            If lblCodCurrier.Text <> "" Then CodCurrier = lblCodCurrier.Text
        Else
            CodCurrier = 0
        End If
        ...
        If Session("Inicio") = "1" Then
            ...
            Mes = Left(FechaActual, 6) & "01"
            FechaEntrega = Mes
            FechaFin = FechaActual()
            Session("Inicio") = "2"
            txtFechaFin.Text = FormatoFecha(FechaFin)
            txtFecha.Text = FormatoFecha(FechaEntrega)
        Else
            FechaFin = Right(txtFechaFin.Text, 4) + Mid(txtFechaFin.Text, 4, 2) + Left(txtFechaFin.Text, 2)
        End If
        Try
            Flex.DataSource = obj.Lista_Guia(Session("Ruta_Emp"), Session("CodEmpresa"), FechaEntrega, CodCurrier, FechaFin)
            Flex.DataBind()
            lblRegistro.Text = Flex.Rows.Count
    ...
    Protected Sub Flex_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles Flex.RowCommand
        ...
        If e.CommandName = "IngEstado" Then
            Try
                If Flex.Rows(Index).Cells(16).Text = "2" Then
                    Editar = True
                End If
                If Flex.Rows(Index).Cells(16).Text = "3" Then
                    Editar = True
                End If
                If Flex.Rows(Index).Cells(16).Text = "1" Then
                    Editar = True
                End If
                If Editar = False Then lblError.Text = "Solo se puede editar los entregados y programados." : Exit Sub
                lblEstEnProceso.Visible = False
                ...
                cboPai101.Items.Add("< Seleccionar >") : cboPai101.SelectedValue = "1"
                ...
                txtSerieGuia.Text = Flex.Rows(Index).Cells(2).Text.Replace("&nbsp;", "")
                txtNroGuia.Text = Flex.Rows(Index).Cells(3).Text.Replace("&nbsp;", "")
                txtDestinatario.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Flex.Rows(Index).Cells(8).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
                txtCodDestino.Text = Flex.Rows(Index).Cells(7).Text.Replace("&nbsp;", "")
                txtEstado.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Flex.Rows(Index).Cells(1).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
                txtCodPedido.Text = Flex.Rows(Index).Cells(14).Text
                txtCodEstado.Text = Flex.Rows(Index).Cells(15).Text
                txtFecReprog1.Text = Flex.Rows(Index).Cells(4).Text.Replace("&nbsp;", "")
                txtCodLiquida.Text = Flex.Rows(Index).Cells(6).Text.Replace("&nbsp;", "")
                txtPerAsignada.Text = Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Replace(Flex.Rows(Index).Cells(12).Text.Trim, "&#250;", "ú"), "&#243;", "ó"), "&#237;", "í"), "&#233;", "é"), "&#225;", "á"), "&quot;", """"), "&#191;", "¿"), "&#241;", "ñ"), "&lt;", "<"), "&gt;", ">"), "&#176;", "º"), "&#211;", "Ó"), "&#193;", "Á"), "&#201;", "É"), "&#205;", "Í"), "&#218;", "Ú"), "&nbsp;", ""), "&#242;", "ò"), "&#236;", "ì"), "&#200;", "È"), "&#209;", "Ñ"), "&#180;", "´")
                Call LlenaComboItem("TBOPC400", cboEstado)
                txtCodCurrier.Text = Flex.Rows(Index).Cells(17).Text
                cboEstado.Items.Add("< Seleccionar >") : cboEstado.SelectedValue = Flex.Rows(Index).Cells(16).Text
            Catch ex As SqlException
    ...
    Protected Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        Try
            ...
            If txtCodEstado.Text <> cboEstado.SelectedValue.Trim Then
    ...
    Protected Sub btnCListar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnCListar.Click
        ...
        lblError.Text = ""
        Try
            FlexCurrier.DataSource = obj.Lista_Currier(Session("Ruta_Emp"), Session("CodEmpresa"), txtCRuc.Text, txtCRazonSocial.Text)
            FlexCurrier.DataBind()
            lblRegistro1.Text = obj.Lista_Currier(Session("Ruta_Emp"), Session("CodEmpresa"), txtCRuc.Text, txtCRazonSocial.Text).Rows.Count
    ...
    Protected Sub cboEstado_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ElseIf cboEstado.SelectedValue = "4" Or cboEstado.SelectedValue = "5" Then
            ...
            txtCodLiquida.MaxLength = 10
        Else
            lblEt15.Text = "N° PAI ó Liquidación"
            txtCodLiquida.MaxLength = 10
            lblEt14.Text = "Fecha Entrega"
            lblEt16.Text = "Hora Entrega"
        End If
