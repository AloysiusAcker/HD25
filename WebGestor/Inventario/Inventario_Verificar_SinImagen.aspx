<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Verificar_SinImagen.aspx.vb" Inherits="Inventario_Inventario_Verificar_SinImagen" %>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <div class="row form-group col-md-12">
                                                ...
                                                <div class="col-sm-2">
                                                    <asp:CheckBox ID="chkPlaca" Text="Generar placa correlativa" runat="server" AutoPostBack="True" />
                                                </div>
                                            </div>
                                            <div class="row form-group col-md-12">
