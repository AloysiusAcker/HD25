<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Relacion_GuiaInterna.aspx.vb" Inherits="Inventario_Inventario_Relacion_GuiaInterna" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <asp:Label ID="LblTitulo" runat="server" Text="Inventario - Guías Internas" CssClass="Titulos"></asp:Label>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-2">
                <asp:Label ID="lblEtiqueta1" CssClass="control-label-2" runat="server" Text="Nro. Guía"></asp:Label>
                 <asp:TextBox ID="TxtNroGuia" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
            <div class="col-md-1">
            </div> 
            <div class="col-md-3">
        ...
        <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
            <ContentTemplate>           
                <div class="row espacio">
                    ...
                    <div class="col-lg-6">
                        <asp:Label ID="lblNombreimg" runat="server" Text="Nombre de la imagen" CssClass="control-label-2" Visible ="false" ></asp:Label>
                        <asp:TextBox ID="TxtNombreImagen" runat="server" CssClass="form-control" Visible ="false" ></asp:TextBox>
                    </div>
                </div> 
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ContentTemplate> 
                    ...
                    <asp:GridView ID="gridGuia" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered GridView" AllowSorting="true" >
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Button ID="BtnPdf" runat="server" Text="Generar PDF" CommandName="Pdf"  ControlStyle-CssClass="btn btn-default" CommandArgument='<%# Container.DataItemIndex %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:ButtonField CommandName="Imagen" Text="Cargar Img" ButtonType="Button" ControlStyle-CssClass="btn btn-default" >
                                <ControlStyle CssClass=" btn btn-default"></ControlStyle>
                            </asp:ButtonField>
                            ...
                            <asp:TemplateField HeaderText="Archivo PDF">
                                <ItemTemplate>
                                    <asp:HyperLink ID="lnkPDF2" runat="server" Text="PDF"  NavigateUrl='<%# Eval("GUIREM_ARCHIVO", "~/Inventario/GuiaInterna/{0}") %>' ></asp:HyperLink>
                                </ItemTemplate>
                            </asp:TemplateField>
                                                    ...
                                                    <div class="col-md-9">
                                                        ...
                                                        <ContentTemplate> 
                                                            <asp:GridView ID="gridDetalleAcc" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered GridView">
                                                                <Columns>
                                                                    <asp:BoundField DataField="Item" HeaderText="Item" SortExpression="Item" />
                                                                    <asp:BoundField DataField="ARTICULO_CODIGO" HeaderText="Cod. Artículo" SortExpression="ARTICULO_CODIGO" />
                                                                    <asp:BoundField DataField="ART_CODEQUIVA" HeaderText="Nro. Parte" SortExpression="ART_CODEQUIVA" />
                                                                    <asp:BoundField DataField="ART_DESCRIPCION" HeaderText="Descripción del Artículo" SortExpression="ART_DESCRIPCION" />
                                                                    <asp:BoundField DataField="ART_SKU" HeaderText="Sku"  SortExpression="ART_SKU"></asp:BoundField>
    ...
    function DescargarPDF(nombreArchivo) {
        var rutaArchivo = "/Archivos/PDF/" + nombreArchivo;
