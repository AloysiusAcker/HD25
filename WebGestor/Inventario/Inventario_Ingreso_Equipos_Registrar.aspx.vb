...
Partial Class Inventario_Inventario_Ingreso_Equipos_Registrar
        ...
        Try
            ...
            If FlexItem.Rows.Count > 0 Then
                For i = 0 To FlexItem.Rows.Count - 1
                    ...
                    drArt = dtArt.NewRow()
                    drArt("Art_Codigo") = FlexItem.Rows(i).Cells(8).Text
                    drArt("Art_Cant_xRec") = psCant.Text
                    drArt("Art_Tipo") = FlexItem.Rows(i).Cells(10).Text
    ...
    Protected Sub FlexTipoPers_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles FlexTipoPers.RowCommand
        ...
        If e.CommandName = "Aceptar" Then
            ...
            txtProvNombre.Text = Session("DestinoDescrip")
        ...
        If e.CommandName = "Aceptar" Then
            ...
            If FlexItem.Rows.Count > 0 Then
                For i = 0 To FlexItem.Rows.Count - 1
                    ...
                    drT("c6") = "S"
                    drT("c7") = FlexItem.Rows(i).Cells(10).Text
