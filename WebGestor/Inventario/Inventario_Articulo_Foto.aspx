<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Articulo_Foto.aspx.vb" Inherits="Inventario_Inventario_Articulo_Foto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:Label ID="LblEtiq1" runat="server" Text="Inventario Artículo Imagen" CssClass="Titulos" />
            </div> 
        </div>
        <div class="row">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                <asp:Button ID="BtnListarxPlacar" runat="server" Text="Listar Art. x Placar" ControlStyle-CssClass="form-control btn btn-default" visible="false"/>
            </div>
        </div>
         <asp:UpdatePanel ID="UpdatePanel1" runat="server">
             <ContentTemplate>    
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="col-md-3">
                        <asp:Button ID="BtnMostrar" runat="server" CssClass="form-control" Text="Mostrar Imagen" />
                    </div>
                    <div class="col-md-3">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <asp:TextBox ID="TxtNombreImagen" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                <div class="row" id="div_imagen" runat="server" visible ="false"  >
                    <div class="col-md-6">
                        <img id="imagenCarga" alt="" src="" class="estiloImagen"  visible ="false"  />
                    </div>
                </div> 
                 <div class="row">
                    <div class="col-md-3">
        ...
        <div class="row">            
            <div class="col-md-3">
                <asp:Label ID="Label1" runat="server" CssClass="control-label-2" Text="c:\ImagenesArticulos"></asp:Label>
                <asp:Button ID="BtnCargaArchivo" runat="server" CssClass="form-control btn btn-default" Text="Carga Fotos" OnClick="BtnCargaArchivo_Click" />
            </div> 
        </div>
         <asp:UpdatePanel ID="UpdatePanel4" runat="server">
             <ContentTemplate>
                ...
                <div class="row">
                        ...
                        <asp:GridView ID="GvListaBienes" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered GridView" >
                            <Columns>
                                ...
                                <asp:TemplateField ItemStyle-Width="20px">
                                    <ItemTemplate>
                                        <asp:Image ID="Image1" runat="server" ImageUrl='<%#"ImagenHandler.ashx?Ruta=" + Session("Ruta_Emp") + "&id=" + HttpUtility.UrlEncode(Convert.ToString(If(Eval("art_codigo") IsNot DBNull.Value, Eval("art_codigo"), Nothing))) %>' Width="50" />
                                        </ItemTemplate>
                                </asp:TemplateField>
                 ...
                 <div class="row">
                    <div class="col-lg-12">
                        <asp:GridView ID="gvListaArticulo" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered GridView" >
                            <Columns>
                                <asp:ButtonField CommandName="Imagen" Text="Ingresar Imagen" >
                                <ItemStyle Width="10%" />
                                </asp:ButtonField>
    ...
    <div id="ModalDetalle" class="modal fade" role="dialog" data-backdrop="static" style="overflow-y: scroll;">
            <div class="modal-dialog" >
                <div class="modal-content">
                    <div class="modal-header" style="padding: 8px 10px; text-align: center; background-color: white;">
                        <asp:Label ID="LblTituloModal" runat="server"  class="subTitulos" Text="Lista de Bienes por Placar" />
                    </div>
                    <div class="form-horizontal">
                        <div class="modal-body" style="padding: 20px 10px 0;">
                                    ...
                                    <div class="panel-body">   
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate> 
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <asp:GridView ID="gvDetalle" runat="server" AutoGenerateColumns="False" CssClass="table table-bordered GridView" >
                                                            <Columns>
                                                                <asp:BoundField DataField="Oficina_Codigo" HeaderText="Cod. Interno" SortExpression="Oficina_Codigo" />
                                                                <asp:BoundField DataField="Ubicacion" HeaderText="Ubicacion" SortExpression="Ubicacion" />
                                            ...
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="gvArtPlacados" EventName="RowCommand" />
                                                <asp:AsyncPostBackTrigger ControlID="gvArtPlacadosOf" EventName="RowCommand" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
