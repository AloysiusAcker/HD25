...
Partial Class Inventario_Inventario_Verificacion_Nueva
                        ...
                        If RsL.HasRows Then
                            While RsL.Read
                                ...
                                If psEstadoInv <> "7" Then
                                    CmdGlobal3.CommandText = " UPDATE TBINVENTARIO_DETALLE SET INVDET_ESTADO_INVENTARIO = '" & psEstadoInv & "', INVDET_ESTADO_CONCILIADO = '1' , INVDET_PLACA_NRO = " & placa & ",  INVDET_ESTADO_ACTIVO = '0' , " _
                                    ...
                                    CmdGlobal3.ExecuteNonQuery() '
                                Else
                                    CmdGlobal3.CommandText = " UPDATE TBINVENTARIO_DETALLE SET INVDET_ESTADO_INVENTARIO = '" & psEstadoInv & "', INVDET_PLACA_NRO = " & placa & ",  INVDET_ESTADO_ACTIVO = '0' , " _
                                ...
                                ElseIf psExiste = "S" Then
                                    CmdGlobal3.CommandText = " update TBINVENTARIO_VERIFICACION set VERIF_RESPONSABLE =  '" & TxtResponsable.Value & "', VERIF_PLACA_NRO= " & placa & ", VERIF_SERIE_NRO='" & serie & "', VERIF_ESTADO_ACTIVO ='0'," _
                                                           & " VERIF_OBSERVACION = '" & TxtObservacionM.Value & "', VERIF_AREA_UBICACION = " & pdCodUbicacion & " ,VERIF_ART_CODIGO = " & TxtCodArticuloM.Value & " , VERIF_ESTADO_ACTIVO'0', " _
                                ...
                                If ChkBienObs.Checked = True Then
                                    ...
                                    CmdGlobal3.ExecuteNonQuery() ' INVDET_INVENTUBIC_CODIGO = " & Nz(Rs!INVENTUBIC_CODIGO) & " AND 
    ...
    Private Sub BtnBuscarBA_Click(sender As Object, e As EventArgs) Handles BtnBuscarBA.Click
        ...
        Try
            ...
            dt = obj.Lista_ArticuloxUbicacionNuevos(psconexion, pdCodUbicacion, psDescripcion)
            If dt.Rows.Count > 0 Then
    ...
    Private Sub BtnGuardarImg_Click(sender As Object, e As EventArgs) Handles BtnGuardarImg.Click
        Try
            ...
            If FileUpload1.HasFile Then
                ...
                '    Using cmd As New SqlCommand("update tbinv_articulos set art_img_nom = @Nombre, art_img = @Imagen  where empresa_codigo = '" & Session("CodEmpresa") & "' and   art_codigo =  " & psCodart & "", con)
