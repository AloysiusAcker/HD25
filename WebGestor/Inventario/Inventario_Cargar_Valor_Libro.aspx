<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Cargar_Valor_Libro.aspx.vb" Inherits="Inventario_Inventario_Cargar_Valor_Libro" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" style="width: 800px">
        ...
        <tr>
            ...
            <td align="left" style="width: 90px; height: 15px" valign="top"></td>
            <td align="left" style="width: 660px; height: 15px" valign="top"></td>
            <td align="left" style="width: 25px; height: 15px" valign="top"></td>
        </tr>
        <tr>
            ...
            <td align="left" style="vertical-align: middle; width: 660px; height: 22px" valign="top">
                <asp:FileUpload ID="NomArchivo" runat="server" Font-Names="Arial" Font-Size="8pt"
                    Style="left: 92px; top: 107px" Width="660px" /></td>
            <td align="left" style="width: 25px; height: 22px" valign="top"></td>
        </tr>
        <tr>
            <td align="left" style="width: 25px; height: 22px" valign="top"></td>
            <td align="left" style="vertical-align: middle; width: 90px; height: 22px" valign="top"></td>
            <td align="left" style="vertical-align: middle; width: 660px; height: 22px; text-align: right"
                valign="top">
