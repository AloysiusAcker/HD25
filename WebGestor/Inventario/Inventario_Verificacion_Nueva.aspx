<%@ Page Title="" Language="VB" MasterPageFile="~/CRM/PagPrincipal_CRM.master" AutoEventWireup="false" CodeFile="Inventario_Verificacion_Nueva.aspx.vb" Inherits="Inventario_Inventario_Verificacion_Nueva" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        document.getElementById("btnCargarImagen").addEventListener("click", function () {
            // Realiza una solicitud AJAX para obtener el nombre de la imagen desde la base de datos.
            var nombreImagen = '<%= Session("nombreImagen") %>';
            var rutaImagen = "Inventario/GuardarImagen/" + nombreImagen; // Construye la ruta de la imagen

            // Selecciona el elemento <img> por su id y establece la ruta de la imagen en el atributo src
            document.getElementById("imagenCarga2").src = rutaImagen;
        });
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-xs-6">
                        <asp:Button ID="BtnIniciarVerificacion" runat="server" Text="Iniciar Verificación" ControlStyle-CssClass="form-control btn btn-default" />
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                                ...
                                <div class="panel-body">
                                    <asp:UpdatePanel ID="UpdatePanel6" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <div class="row form-group col-md-12">
                                                <div class="col-md-3">
                                                    <button type="button" class="form-control btn btn-success" data-toggle="modal" data-target="#photoModal">
                                                            Abrir Galería
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group col-md-12">
                                                ...
                                                <div class="col-sm-3 col-xs-6">
                                                    <asp:Button ID="BtnAgregarArticulo" ControlStyle-CssClass="btn btn-success" runat="server" Text="Agregar" />
                                                </div>
                                                <div class="col-sm-3 col-xs-6">
                                            ...
                                            <div class="row form-group col-md-12">
                                                <asp:UpdatePanel ID="UpdatePanel13" runat="server">
                                                    <ContentTemplate>
                                                        <asp:Label ID="lblImagen" runat="server" Text="Imagen :" Class="control-label col-sm-3 col-xs-12" ></asp:Label>
