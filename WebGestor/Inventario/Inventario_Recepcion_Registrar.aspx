<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Recepcion_Registrar.aspx.vb" Inherits="Inventario_Inventario_Recepcion_Registrar" %>
                        ...
                        <ContentTemplate>
                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                <ContentTemplate>     
                                    ...
                                    <div class="row espacio" runat="server" id="Exportar" visible="false" >
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Button ID="btnGuardarExcel" Text="Guardar desde Excel" runat="server" ControlStyle-CssClass="form-control btn btn-default"></asp:Button> 
                                        </div>
                                        <div class="col-lg-2">
                            ...
                            <ContentTemplate>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-xs-2">
                                        <asp:Label ID="Label13" runat="server" CssClass="control-label" Text="Clasif" forecolor="White" />
                                ...
                                <div class="row espacio">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label id="label111" runat="server" Text="Marca" ForeColor="white" />
                                        <asp:Button ID="BtnBuscaMarcaBA" runat="server" Text="..." ControlStyle-CssClass="btn btn-block" />
                                    </div>
                                    <asp:Label ID="LblCodMarcaBA" runat="server" CssClass="control-label" Visible="false" />
                                </div>
                                <div class="row espacio">
                                    ...
                                    <div class="col-md-2">
                                        <asp:Label id="label23" runat="server" Text="Mod" ForeColor="white" />
                                        <asp:Button ID="BtnBuscaModeloBA" runat="server" Text="..."    ControlStyle-CssClass="btn btn-block" />
                                    </div>
                                    <asp:Label ID="LblCodModeloBA" runat="server" CssClass="control-label" Visible="false" />
                                </div>
                                <div class="row espacio">
