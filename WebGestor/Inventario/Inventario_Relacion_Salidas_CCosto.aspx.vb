...
Imports System.Data
Partial Class Inventario_Inventario_Relacion_Salidas_CCosto
    ...
    Private Sub BtnListar_Click(sender As Object, e As EventArgs) Handles BtnListar.Click
        ...
        Try
            ...
            gridSalida.DataSource = obj.Lista_SalidacCCosto(psConexion, Session("CodEmpresa"), pCodSalida, psFecha, psFechaFin, psMotivo, psEstado)
            gridSalida.DataBind()
    ...
    Private Sub gridSalida_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridSalida.RowCommand
        ...
        If e.CommandName = "Eliminar" Then
            ...
            lblCodEstado.Text = gridSalida.Rows(Index).Cells(12).Text
            Session("AnulCodEstado") = gridSalida.Rows(Index).Cells(12).Text
