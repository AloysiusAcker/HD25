...
Partial Class Inventario_Inventario_Conciliados_OtrosBienes
    ...
    Protected Sub Listar_OtrosEquipos()
        ...
        dt.Columns.Add("AREA_NOMBRE") 'SERIE_STATUSU
        dt.Columns.Add("SERIE_STATUSU") 'Ubicacion_Cod_Interno
        dt.Columns.Add("Ubicacion")
        dt.Columns.Add("Ubicacion_Cod_Interno")
        ...
        dtO = obj.Inventario_BienesOtros_Paraconciliar(Session("Ruta_Emp"), pdCodinventario, codigo, tipo, ubicacion, 0)
        If dtO.Rows.Count > 0 Then
            For Each dr As DataRow In dtO.Rows
                ...
                drT2("Ubicacion") = Nu(dr("Ubicacion"))
                drT2("Ubicacion_Cod_Interno") = Nu(dr("Ubicacion_Cod_Interno"))
                dt.Rows.Add(drT2)
