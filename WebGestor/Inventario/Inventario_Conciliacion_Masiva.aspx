<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Conciliacion_Masiva.aspx.vb" Inherits="Inventario_Inventario_Conciliacion_Masiva" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <asp:Label ID="LblEtiq1" runat="server" Text="Conciliación Masiva por Inventario" CssClass="Titulos" />
            </div> 
        </div>
        <br />
        <div class="row">
            ...
            <div class="col-md-3 col-xs-6">
                <asp:Button ID="BtnListaConciliados" runat="server" Text="Lista Equipos Conciliados"  ControlStyle-CssClass="form-control btn btn-default" />
            </div>
            <div class="col-md-3 col-xs-6">
                <asp:Button ID="BtnExportarConciliados" runat="server" Text="Exportar Equipos Conciliados"  ControlStyle-CssClass="form-control btn btn-default" />
            </div>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            ...
            <Triggers>
                ...
                <asp:AsyncPostBackTrigger ControlID="BtnListaConciliados" EventName="Click" />
