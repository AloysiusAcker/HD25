<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Carga_MovGps.aspx.vb" Inherits="Inventario_Inventario_Carga_MovGps" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">

       <div class="row">
            <div class="col-lg-12">
                <asp:Label ID="LblEtiq1" runat="server" Text="Inventario Genera Mov. Varios GPS" CssClass="Titulos" />
            </div> 
        </div>
        <br />
        ...
        <div class="row">
            <div class="col-lg-2">
                <asp:Button ID="BtnCargarInvOk" runat="server" Text="Cargar Bienes Inv. Ok"  visible="false" ControlStyle-CssClass="form-control btn btn-default" />
            </div> 
        </div> 
        <div class="row">
            <div class="col-lg-2">
            ...
            <div class="col-lg-2">
                <asp:Button ID="BtnExportar" runat="server" Text="Exportar Lista"  CssClass="form-control btn btn-default"/>
            </div>
        </div>
