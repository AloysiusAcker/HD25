<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_Resumen.aspx.vb" Inherits="Inventario_Inventario_Resumen" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <style>
        /* Estilos para el formato de la etiqueta */
        /*body {
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <asp:Button ID="BtnCC" runat="server" Text="Exportar CAF y CC " CssClass="form-control btn btn-default"/>
            </div>
            <div class="col-lg-3">
        ...
        <div class="row">
            <div class="col-lg-3">
                <asp:Button ID="BtnGenerar" runat="server" Text="Archivo Bienes x Placar" CssClass="form-control btn btn-default"/>
            </div>
            <div class="col-lg-3">
                <asp:Button ID="BtnInforme" runat="server" Text="Informe" CssClass="form-control btn btn-default"/>
            </div>
            <div class="col-lg-3">
                <asp:Button ID="BtnImprimir" runat="server" Text="Imprimir Placas" CssClass="form-control btn btn-default"/>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
                            ...
                            <div class="card">
                                ...
                                <div id="section1ContentId" class="collapse" role="tabpanel" aria-labelledby="section1HeaderId">
                                    <div class="card-body">       
                                         <div class="row">                    
                                            <div class="col-lg-9">
                                                <asp:Label ID="lblCantRegistro" runat="server" class="control-label-2" Text="" ></asp:Label>
                                            </div> 
                                        </div> 
                                        <div class="row">
                                            <div class="col-lg-9">
                                                <asp:GridView ID="gvDetalle" AutoGenerateColumns="false" Width="50%" runat="server" CssClass="table table-bordered GridView">
                                                    <Columns>
