<%@ Page Title="" Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inventario_CCosto_Salida_Generar.aspx.vb" Inherits="Inventario_Inventario_CCosto_Salida_Generar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <asp:Label ID="LblEtiq1" runat="server" Text="Inventario - Nueva Salida de Centro de Costos" CssClass="Titulos" />
            </div> 
        </div>
        <br />
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel12" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <asp:Label ID="Label20" runat="server" text="Bus" CssClass="control-label-2" ForeColor="White" />
                                                    <asp:Button ID="BtnBuscarBA" runat="server" Text="Buscar" CssClass="form-control btn btn-default" />
                                                </div>
                                                <div class="col-md-2">
                                                    <asp:Label ID="Label21" runat="server" text="Bus" CssClass="control-label-2" ForeColor="White" />
