<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inspeccion_Lista_DatosAdicionales_Usuarios.aspx.vb" Inherits="Inspeccion_Lista_DatosAdicionales_Usuarios" title="Servicio - Lista Datos Adicionales de Usuario" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="text-align: left">
     ...
     <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
        <tr>
            <td align="left" colspan="7" style="height: 50px; text-align: center;" valign="top">
                <div id="lblTitulo" runat="server" class="EstiloTitleMenu" style="font-weight: bold;
                    ...
                    text-align: center">
                    Datos Adicionales de Usuarios</div>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" style="width: 25px; height: 255px" valign="middle">
            </td>
            <td align="left" colspan="5" style="height: 255px" valign="middle">
                        ...
                        <div id="DIV2" runat="server" style="border-right: darkgray 1px outset; border-top: gray 1px outset;
                            ...
                            <asp:GridView ID="Flex" runat="server" AutoGenerateColumns="False" Font-Names="Arial"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="FECHA_RELIZA" HeaderText="Fecha Realizada">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    ...
                                    <asp:BoundField DataField="INSPEC_MOVILIDAD" HeaderText="Movilidad Ida">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="INSPEC_MOVILIDAD_VUELTA" HeaderText="Movilidad Vuelta">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="INSPEC_MOVILIDAD_DESCRIPCION" HeaderText="Movilidad Descripcion">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="200px" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="OBJETIVO" HeaderText="Estado Objetivo">
                                        <HeaderStyle HorizontalAlign="Center" VerticalAlign="Middle" />
                                        <ItemStyle HorizontalAlign="Left" VerticalAlign="Middle" Width="100px" />
                                    </asp:BoundField>
            ...
            <td align="left" style="width: 42px; height: 255px" valign="middle">
            </td>
        </tr>
        <tr>
            <td align="left" style="width: 25px; height: 22px" valign="middle">
