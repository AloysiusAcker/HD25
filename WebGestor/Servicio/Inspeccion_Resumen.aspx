<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inspeccion_Resumen.aspx.vb" Inherits="Inspeccion_Resumen" title="Servicio - Resumen" %>
     ...
     <asp:Panel ID="panelUpdateProgress" runat="server" Width="200px" CssClass="updateProgress">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 600px">
            ...
            <tr>
                ...
                <td align="left" style="width: 89px; height: 15px" valign="top">
                </td>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 89px; height: 25px" valign="top">
                ...
                <td align="left" style="vertical-align: middle; width: 175px; height: 25px; text-align: right;" valign="top">
                    <asp:Button ID="btnExportar" runat="server" BackColor="LightGray" BorderColor="Gray"
                        ...
                        Text="Exportar" Width="60px" /><asp:Button ID="btnListar" runat="server" BackColor="LightGray" BorderColor="Gray"
                        BorderStyle="Outset" BorderWidth="1px" Font-Names="Arial" Font-Size="8pt" ForeColor="Gray"
                        Text="Listar" Width="60px" /></td>
                <td align="left" style="width: 25px; height: 25px" valign="top">
                </td>
            </tr>
            <tr>
...
<asp:AsyncPostBackTrigger ControlID="FlexOf" EventName="RowCommand"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" style="vertical-align: middle; width: 20px; height: 25px" valign="top">
                    <asp:Button ID="btnBuscar" runat="server" BackColor="LightGray" BorderColor="Gray"
                        BorderStyle="Outset" BorderWidth="1px" Font-Names="Arial" Font-Size="8pt" ForeColor="Gray"
                        Text="..." Width="18px" /></td>
                <td align="left" colspan="4" style="vertical-align: middle; height: 25px" valign="top">
...
<asp:AsyncPostBackTrigger ControlID="txtCodIntOficina" EventName="TextChanged"></asp:AsyncPostBackTrigger>
            ...
            <tr>
                ...
                <td align="left" style="vertical-align: middle; width: 89px;" valign="top">
                    <asp:UpdatePanel id="UpdatePanel5" runat="server">
                        <contenttemplate>
<asp:TextBox id="txtCodOficina" runat="server" Width="41px" Font-Size="8pt" Font-Names="Arial" Visible="False"></asp:TextBox> 
</contenttemplate>
                        <triggers>
<asp:AsyncPostBackTrigger ControlID="txtCodIntOficina" EventName="TextChanged"></asp:AsyncPostBackTrigger>
<asp:AsyncPostBackTrigger ControlID="FlexOf" EventName="RowCommand"></asp:AsyncPostBackTrigger>
                ...
                <td align="left" style="vertical-align: middle; width: 175px; text-align: right"
                    valign="top">
                </td>
                <td align="left" style="width: 25px;" valign="top">
                </td>
            ...
            <tr>
                ...
                <td align="left" colspan="7" style="vertical-align: middle; height: 25px" valign="top">
            ...
            <tr>
                ...
                <td align="left" colspan="7" style="vertical-align: middle; height: 22px" valign="top">
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
<DIV style="BORDER-RIGHT: darkgray 1px outset; BORDER-TOP: darkgray 1px outset; OVERFLOW: auto; BORDER-LEFT: darkgray 1px outset; WIDTH: 550px; BORDER-BOTTOM: darkgray 1px outset; POSITION: static; HEIGHT: 274px"><asp:GridView id="Flex" runat="server" Width="1280px" Font-Size="8pt" Font-Names="Arial" BorderWidth="1px" BorderStyle="Outset" BorderColor="DarkGray" AutoGenerateColumns="False" PageSize="8"><Columns>
