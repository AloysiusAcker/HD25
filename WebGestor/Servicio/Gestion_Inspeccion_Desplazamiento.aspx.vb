...
Imports System.Data
Imports WebGestor
Partial Class Gestion_Inspeccion_Desplazamiento
    ...
    Private Sub Lista_Inspeccion()
        ...
        End If
        Try
            dtLista = obj.Listar_Inpeccion_Desplazamiento(psConexion, Session("CodEmpresa"), TipoPersona, _
                                                          TipoInspeccion, TipoEstado, FechaIni, FechaFin, pdCodOficina, Tecnico, NroInspeccion)
            Flex.DataSource = dtLista
            Flex.DataBind()
    ...
    Private Sub Exportar_Excel()
        ...
        Response.AddHeader("Content-Disposition", "attachment;filename=GestionDesplazamiento.xls")
