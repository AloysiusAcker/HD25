<%@ Page Language="VB" MasterPageFile="~/PagPrincipal_A.master" AutoEventWireup="false" CodeFile="Inspeccion_Reporte_ReqAd.aspx.vb" Inherits="Inspeccion_Reporte_ReqAd" title="Servicio - Requerimientos Adicionales" %>
        ...
        <tr>
            <td align="left" colspan="7" style="height: 50px; text-align: center;" valign="top">
                <div id="lblTitulo" runat="server" class="EstiloTitleMenu" style="font-weight: bold;
                    font-size: 14pt; left: 253px; vertical-align: middle; width: 580px; color: gray;
                    font-style: italic; font-family: 'Bell MT', Broadway, Arial, Serif; top: 275px;
                    text-align: center">
                    Requerimiento Adicional de Servicios Integrales&nbsp;</div>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="7" style="height: 22px" valign="middle">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 300px">
                                <tr>
                                    <td align="left" style="vertical-align: middle; width: 105px; height: 22px; text-align: left"
                                        valign="top">
                            ...
                            <asp:TextBox ID="txtPorFechaFin" runat="server" Font-Names="Arial" Font-Size="8pt"
                                Width="95px"></asp:TextBox></td>
                                    <td align="left" style="vertical-align: middle; width: 85px; height: 22px; text-align: left"
                                        valign="top">
                                    </td>
                                </tr>
                            </table>
        ...
        <tr>
            ...
            <td align="left" colspan="5" valign="middle" style="height: 210px">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
<DIV style="BORDER-RIGHT: darkgray 1px outset; BORDER-TOP: gray 1px outset; OVERFLOW: auto; BORDER-LEFT: darkgray 1px outset; WIDTH: 550px; BORDER-BOTTOM: darkgray 1px outset; POSITION: static; HEIGHT: 245px" id="DIV2" runat="server"><asp:GridView id="Flex" runat="server" Width="1420px" Font-Size="8pt" Font-Names="Arial" AutoGenerateColumns="False" OnRowCommand="Flex_RowCommand"><Columns>
...
<asp:BoundField DataField="NRO_VISITA" HeaderText="N&#176; Visita">
...
<asp:BoundField DataField="INSPEC_TRABREALIZADO" HeaderText="Trabajo a Realizar / Relaizado">
...
<asp:BoundField DataField="HORA_INICIO_1" HeaderText="Hora Inicio">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="HORA_FIN_1" HeaderText="Hora Fin">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="EXTRA_HORA_1" HeaderText="25 %">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="HORA_INICIO_2" HeaderText="Hora Inicio">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="HORA_FIN_2" HeaderText="Hora Fin">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="EXTRA_HORA_2" HeaderText="35 %">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
<asp:BoundField DataField="Domingo" HeaderText="100 %">
<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Width="60px"></ItemStyle>
</asp:BoundField>
</Columns>
</asp:GridView> </DIV>
